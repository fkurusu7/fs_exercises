...
describe("favorite likes, most posts", () => {
  const blogs = [
    {
      _id: "5a422a851b54a676234d17f7",
      title: "React patterns",
  ...
  test("favorite blog post, which blog post has the most likes", () => {
    const expectedMaxLikesPost = {
      title: "Canonical string reduction",
      author: "Edsger W. Dijkstra",
      likes: 12,
    };
    const result = listHelper.favoriteBlog(blogs);
    assert.deepStrictEqual(result, expectedMaxLikesPost);
  });

  test("author with most posts", () => {
    const expectedAuthor = { author: "Robert C. Martin", count: 3 };
